 ...
 */
function dddlx_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['dddlx_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('dddlx sample setting'),
  '#default_value' => theme_get_setting('dddlx_example'),
